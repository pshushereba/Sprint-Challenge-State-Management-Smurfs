...
- [x] What problem does the context API help solve?
  - Context API is a tool that allows us to manage state easier. It keeps us from needing to use "prop drilling" in order to access the information that we need.
